...
#sparrow.famped <- sparrow.famped[which(sparrow.famped$ANIMAL %in% qc1$idok),]
...
#write.table(all.xovers, file = "sparrow.xovers.clean.all.txt", row.names = FALSE, col.names = TRUE)
